...
public class GreetingServiceImpl extends RemoteServiceServlet implements GreetingService 
{
	...
	public Usuario validarUsuario(String user, String pass) {
		return ManagerMysql.getInstance().validarUsuario(user, pass);
	}

	@Override
	public boolean cambiarPassword(Usuario usuarioLogeado,String confirmacionPass) 
	{
		return ManagerMysql.getInstance().cambiarPassword(usuarioLogeado, confirmacionPass);
	}

	@Override
	public Characters[] consultarPersonajes(Usuario usuarioLogeado,	String nombreCuenta) 
	{
		return ManagerMysql.getInstance().consultarPersonajes(usuarioLogeado,	nombreCuenta);
	}

	@Override
	public PersonajesCuenta[] consultarPersonajesPorCuenta() {
		return ManagerMysql.getInstance().consultarPersonajesPorCuenta();
	}
}
